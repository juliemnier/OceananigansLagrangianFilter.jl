...
=================
  ...
  - `regrid_to_mean`: A `Bool` indicating whether to perform the final interpolation of the filtered fields onto the mean position. Requires `map_to_mean = true`. Set to `false` to write the ξ maps
    without paying for the regridding. Default: `map_to_mean`.
